...
const FACILITIES = {
  startup: {
    ...
    description:
      "Spacious private offices and conference rooms tailored for growing startups and team collaborations.",
    image:
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span
                          className={`font-medium ${facility.status === "Available" ? "text-success" : "text-warning"}`}
                        >
                          {facility.status}
                        </span>
                      </div>
                    ...
                    <div className="p-4 bg-surface rounded-xl border border-border-main flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-text-main/70">
                          {facility.hours}. Staff available Monday to Saturday,
                          9 AM - 7 PM.
                        </p>
                      </div>
                    </div>
