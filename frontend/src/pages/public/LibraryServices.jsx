  ...
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-6xl font-extrabold text-text-main tracking-tight mb-6 leading-tight">
                The ultimate <span className="text-secondary">focus zone.</span>
              </h1>
              <p className="text-lg md:text-xl text-text-main/70 mb-8 leading-relaxed">
                Engineered for absolute silence. Our library spaces feature
                ergonomic seating, high-speed Wi-Fi, and natural lighting to
                keep you productive.
              </p>
            ...
            {[
              {
                ...
                desc: "Strict silence policies in all library zones ensuring you can focus.",
              },
              {
                icon: Wifi,
                title: "Dedicated Wi-Fi",
                desc: "Priority bandwidth for library members. No buffering, no drops.",
              },
              {
                icon: Coffee,
                title: "Café Access",
                desc: "Step out into our adjacent premium café when you need a break.",
              },
            ].map((feature, i) => (
              <Card
                key={i}
                className="hover:-translate-y-1 border-0 shadow-sm bg-background"
              >
      ...
      <section className="text-center py-6">
        ...
        <img
          src="https://images.unsplash.com/photo-1521587760476-6c12a4b040da?auto=format&fit=crop&q=80"
          alt="Rows of bookshelves in the library reading zone"
          loading="lazy"
          className="w-full h-64 md:h-80 object-cover mt-16"
        />
      </section>
    </div>
  );
