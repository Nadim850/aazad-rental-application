...
const LIBRARY_FACILITY = {
  ...
  name: "Library Zone",
  description:
    "A pin-drop silence zone designed for deep focus, research, and uninterrupted study. Ideal for students, researchers, and writers.",
  image:
            ...
            <div className="rounded-2xl overflow-hidden border border-border-main shadow-lg bg-surface relative group">
              <div className="aspect-[4/3] relative overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 right-4 text-white">
                  <Badge
                    variant="primary"
                    className="mb-2 bg-primary/90 text-white border-none shadow-sm backdrop-blur-md"
                  >
                    {LIBRARY_FACILITY.workspaceType}
                  </Badge>
                  <h2 className="text-2xl font-bold">
                    {LIBRARY_FACILITY.name}
                  </h2>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span
                      className={`font-medium ${LIBRARY_FACILITY.status === "Available" ? "text-success" : "text-warning"}`}
                    >
              ...
              >
                ...
                <section>
                  <div className="mb-6 border-b border-border-main pb-4">
                    ...
                    <p className="text-text-main/60 mt-1">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                    {LIBRARY_FACILITY.amenities.map((amenity, idx) => (
                      <div
                        key={idx}
                        className="flex flex-col items-center justify-center p-4 bg-surface border border-border-main/50 rounded-xl text-center hover:border-primary/50 transition-colors group"
                      >
                  ...
                  {isLoading ? (
                    ...
                    <Card className="bg-surface/50 border-dashed border-border-main text-center p-12">
                      <p className="text-text-main/50">
                        No plans currently available for this facility.
                      </p>
                    </Card>
                  ) : (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {plans.map((plan) => {
                        ...
                        return (
                          <Card
                            key={plan.id}
                            className="relative overflow-hidden flex flex-col h-full hover:border-primary/50 transition-colors"
                          >
                            {savingsPct > 0 && (
                            ...
                            <CardHeader className="bg-primary/5 pb-4 border-b border-border-main/50 relative">
                              ...
                              <div className="mt-2">
                                ...
                                <span className="text-sm text-text-main/60 ml-1">
                                  /{duration}{" "}
                                ...
                                {savingsPct > 0 && (
                                  <div className="text-xs text-text-main/50 line-through mt-1">
                                    ₹
                                    {(
                                      parseFloat(plan.monthly_price) * duration
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 bg-surface rounded-xl border border-border-main flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-text-main/70">
                          {LIBRARY_FACILITY.hours}. Staff available Monday to
                          Saturday, 9 AM - 7 PM.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="p-4 bg-surface rounded-xl border border-border-main flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-text-main/70">
                          Seats are subject to availability. You can choose a
                          specific seat during the booking process.
                        </p>
                      </div>
                    </div>
                    <div className="p-4 bg-surface rounded-xl border border-border-main flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-text-main/70">
                          By booking, you agree to our community guidelines and
                          silence policies.
                        </p>
                      </div>
                    </div>
