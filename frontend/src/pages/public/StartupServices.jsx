        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold text-text-main tracking-tight mb-6 leading-tight max-w-4xl mx-auto">
              Premium <span className="text-secondary">Conference Rooms</span>{" "}
              for your teams.
            </h1>
            <p className="text-lg md:text-xl text-text-main/70 mb-10 leading-relaxed max-w-2xl mx-auto">
              Custom-built suites, high-tech conference rooms, and
              enterprise-grade infrastructure. Scale your team without worrying
              about the lease.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center mb-24">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-text-main/70 mb-8 text-lg">
                State-of-the-art meeting spaces designed for high-stakes
                pitches, collaborative workshops, and executive board meetings.
              </p>
              <ul className="space-y-4">
                <li className="flex items-center gap-3 text-text-main/80">
                  <CheckCircle2 className="w-5 h-5 text-secondary" /> 4K
                  presentation displays with Apple TV/Chromecast
                </li>
                <li className="flex items-center gap-3 text-text-main/80">
                  <CheckCircle2 className="w-5 h-5 text-secondary" />{" "}
                  High-fidelity conference audio & camera setup
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="border-0 shadow-sm bg-surface">
              <CardContent className="p-8">
                ...
                <p className="text-text-main/70">
                  Spacious and comfortable private office designed to perfectly
                  accommodate a growing team of up to 6 members.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-sm bg-surface">
              <CardContent className="p-8">
                ...
                <p className="text-text-main/70">
                  Private VLANs, dedicated bandwidth allocations, and secure
                  server rack space available for your team's exclusive use.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-sm bg-surface">
              <CardContent className="p-8">
                ...
                <p className="text-text-main/70">
                  24/7 biometric access control, localized CCTV monitoring, and
                  strict guest registration protocols for total peace of mind.
                </p>
              </CardContent>
            </Card>
          </div>
