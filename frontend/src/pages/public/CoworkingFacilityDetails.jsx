...
export default function CoworkingFacilityDetails() {
  ...
  const [activeFacility, setActiveFacility] = useState('dedicated');
  ...
  useEffect(() => {
    ...
    if (planParam === 'dedicated-private' || planParam === 'cabin') setActiveFacility('cabin');
    else setActiveFacility('dedicated'); // default
  }, [searchParams]);
    ...
    <div className="min-h-screen bg-background pt-6 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          {/* Sub-Facility Selector Tabs */}
          {!isBookingMode && (
            <div className="bg-border-main/30 p-1 rounded-xl inline-flex overflow-x-auto no-scrollbar w-full sm:w-auto">
