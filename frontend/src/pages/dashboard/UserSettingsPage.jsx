...
export default function UserSettingsPage() {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      await apiFetch(`${API_URL}/api/accounts/preferences/`, {
        method: "PATCH",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <Input
                  ...
                  disabled
                  className="bg-surface/50 opacity-70"
                />
        ...
        <CardContent>
          <div className="space-y-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-text-main/60">
                    Receive alerts directly within the dashboard.
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 rounded-xl border border-border-main/50 bg-surface">
              <div className="flex items-center gap-3">
                <div className="p-2 rounded-full bg-primary/10 text-primary">
                  <span className="w-5 h-5 font-bold flex items-center justify-center text-sm">
                    @
                  </span>
                </div>
                <div>
                  ...
                  <p className="text-xs text-text-main/60">
                    Receive important updates and receipts via email.
                  </p>
                </div>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
